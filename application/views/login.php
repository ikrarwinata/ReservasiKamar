								...
								<div class="widget-body">
									<div class="widget-main">
										...
										<?php if ($this->session->userdata("message") != NULL) : ?>
											<div class="well well-sm btn-danger">
												<?php echo $this->session->userdata("message") ?>
											</div>
										<?php endif ?>
										<div class="space-6"></div>

										<form action="CPublic/login_action" method="post">
											<fieldset>
...
-->
									...
									<div class="toolbar clearfix">
										...
										<div>
											<a href="CPublic/register" class="user-signup-link">
												Daftar Baru
							...
							<div id="forgot-box" class="forgot-box widget-box no-border">
								<div class="widget-body">
									<div class="widget-main">
										...
										<div class="space-6"></div>
										<p>
											Isi data berikut untuk mendapatkan password anda kembali
										</p>

										<form action="CPublic/lupa_password" method="post">
											<fieldset>
												<label class="block clearfix">
													<span class="block input-icon input-icon-right">
												...
												<label class="block clearfix">
													<span class="block input-icon input-icon-right">
														<input type="email" class="form-control" name="email" placeholder="Email yang anda gunakan saat mendaftar" />
