	...
	<div class="col-xs-12">
		...
		<div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
				<div class="btn-group btn-corner">
					...
					<ul id="export" class="dropdown-menu dropdown-success hide">
						<li>
							<a href="admin/Riwayattamu/excel/">Export semua data</a>
						</li>

						<li class="divider"></li>

						<li>
							<a href="admin/Riwayattamu/excel?start=<?php echo $start ?>&q=<?php echo $q ?>&limit=10" target="_blank">Export Halaman ini</a>
						</li>
						
						<li>
							<a href="admin/Riwayattamu/excel?&q=<?php echo $q ?>" target="_blank">Export semua hasil pencarian ini</a>
						</li>
					</ul>
					...
					<ul id="print" class="dropdown-menu dropdown-info hide">
						<li>
							<a href="admin/Riwayattamu/print_page/" target="_blank">Print semua data</a>
						</li>

						<li class="divider"></li>

						<li>
							<a href="admin/Riwayattamu/print_page?start=<?php echo $start ?>&q=<?php echo $q ?>&limit=10" target="_blank">Print Halaman ini</a>
						</li>
						
						<li>
							<a href="admin/Riwayattamu/print_page?&q=<?php echo $q ?>" target="_blank">Print semua hasil pencarian ini</a>
						</li>
					</ul>
					<?php if($this->session->userdata('level')==2){ ?>
					<a href="admin/Riwayattamu/clear" class="btn btn-white btn-danger tooltips-slide-down" title="Bersihkan semua riwayat" onclick="return confirm('Anda yakin ingin menghapus semua riwayat ?')">
            ...
            <div class="col-md-4 text-right">
                <form action="<?php echo site_url('admin/Riwayattamu/index'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('admin/Riwayattamu'); ?>" class="btn btn-default btn-sm">Reset</a>
                                    <?php
                                }
                            ?>
				...
				<table id="simple-table" class="table  table-bordered table-hover">
					...
					<tbody>
						...
						<tr>
							...
							<td class="hidden-480"><?php echo format_date($kamar->tglmasuk) ?></td>
							<td class="hidden-480"><?php echo format_date($kamar->tglkeluar) ?></td>
							<td class="hidden-480"><?php echo $kamar->namapelanggan ?></td>
							<td class="hidden-480"><?php echo format_number($kamar->pembayaran) ?></td>
							<td>
										...
										<div class="col-xs-12 col-sm-8">
											...
											<div class="profile-user-info profile-user-info-striped">
												...
												<div class="profile-info-row">
													<div class="profile-info-name"> Petugas </div>

													<div class="profile-info-value">
														<span><?php echo $kamar->namapetugas ?></span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<a href="admin/Pelanggan/read/<?php echo $kamar->idpelanggan ?>"><?php echo $kamar->namapelanggan ?></a>
													</div>
												</div>
												...
												<div class="profile-info-row">
													<div class="profile-info-name"> Tanggal Lahir Tamu </div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														...
														<span><?php echo get_str_day($kamar->tglmasuk) ?></span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<i class="fa fa-clock light-orange bigger-110"></i>
														<span><?php echo get_str_day($kamar->tglkeluar) ?></span>
													</div>
												</div>
											</div>
										</div>
