	...
	<div class="col-xs-12">
		...
		<div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
				<div class="btn-group btn-corner">
					...
					<ul id="export" class="dropdown-menu dropdown-success hide">
						<li>
							<a href="admin/Pelanggan/excel/">Export semua data</a>
						</li>

						<li class="divider"></li>

						<li>
							<a href="admin/Pelanggan/excel?start=<?php echo $start ?>&q=<?php echo $q ?>&limit=10" target="_blank">Export Halaman ini</a>
						</li>
						
						<li>
							<a href="admin/Pelanggan/excel?&q=<?php echo $q ?>" target="_blank">Export semua hasil pencarian ini</a>
						</li>
					</ul>
					...
					<ul id="print" class="dropdown-menu dropdown-info hide">
						<li>
							<a href="admin/Pelanggan/print_page/" target="_blank">Print semua data</a>
						</li>

						<li class="divider"></li>

						<li>
							<a href="admin/Pelanggan/print_page?start=<?php echo $start ?>&q=<?php echo $q ?>&limit=10" target="_blank">Print Halaman ini</a>
						</li>
						
						<li>
							<a href="admin/Pelanggan/print_page?&q=<?php echo $q ?>" target="_blank">Print semua hasil pencarian ini</a>
						</li>
					</ul>
					
					<a href="admin/Pelanggan/create" class="btn btn-white btn-success tooltips-slide-down" title="Tambah data">
            ...
            <div class="col-md-4 text-right">
                <form action="<?php echo site_url('admin/Pelanggan/index'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        <input type="text" class="form-control search-query" name="q" value="<?php echo $q; ?>" placeholder="Cari data tamu">
                        <span class="input-group-btn">
                            <?php 
                                if ($q <> '')
                                {
                                    ?>
                                    <a href="<?php echo site_url('admin/Pelanggan'); ?>" class="btn btn-default btn-sm">Reset</a>
                                    <?php
                                }
                            ?>
			...
			<div class="col-xs-12">
				<table id="simple-table" class="table  table-bordered table-hover">
					...
					<tbody>
						...
						<tr>
							<td class="center">
								<label class="pos-rel data-id"><?php echo $pelanggan->idpelanggan ?></label>
							</td>
							...
							<td>
								<a href="admin/Pelanggan/read/<?php echo $pelanggan->idpelanggan ?>"><?php echo $pelanggan->nama ?></a>
							</td>
							<td><?php echo $pelanggan->jeniskelamin ?></td>
							<td class="hidden-480"><?php echo $pelanggan->email ?></td>
									...
									<div class="row">
										<div class="col-xs-12 col-sm-2">
											<div class="text-center">
												<?php 
												if($pelanggan->fotoprofil!==NULL){
												?>
												<img height="150" class="thumbnail inline no-margin-bottom" alt="<?php echo $pelanggan->nama ?>" src="<?php echo $pelanggan->fotoprofil ?>" />
												<?php 
												}else{
												?>
												<img height="150" class="thumbnail inline no-margin-bottom" alt="<?php echo $pelanggan->nama ?>" src="uploads/pelanggan/profile/usernoimage.png" />
												<?php 
												}
												?>
												<br />
												<div class="width-80 label label-info label-xlg arrowed-in arrowed-in-right">
													<div class="inline position-relative">
														<a class="user-title-label" href="#">
															...
															&nbsp;
															<span class="white"><?php echo str_shortened($pelanggan->nama,13) ?></span>
														</a>
													</div>
												</div>
											</div>
											...
											<div class="profile-user-info profile-user-info-striped">
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span><?php echo $pelanggan->username ?></span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span><?php echo $pelanggan->password ?></span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span><?php echo $pelanggan->email ?></span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span><?php echo $pelanggan->telepon ?></span>
													</div>
												</div>
...
<!--														<i class="fa fa-map-marker light-orange bigger-110"></i>-->
														<span><?php echo $pelanggan->jeniskelamin ?></span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span><?php echo (date("Y") - explode("-", $pelanggan->tgllahir)[2]) ?></span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span><?php echo $pelanggan->tgllahir ?></span>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="col-xs-12 col-sm-2">
											<div class="text-center">
												<img height="150" class="thumbnail inline no-margin-bottom" alt="<?php echo $pelanggan->nama ?>" src="<?php echo $pelanggan->fotoktp ?>" />
											</div>
										</div>
									</div>
								</div>
